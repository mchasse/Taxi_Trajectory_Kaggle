...
lat_low, lat_hgh = np.percentile(latlong[:,0], [2, 98]) #from latlong 2D array get lattitude array and get the values between 2% to 98% of the sample
lon_low, lon_hgh = np.percentile(latlong[:,1], [2, 98]) # do the same for longitude
